...
public class InterfaceCallUtils {
	 ...
	 * 发送http请求
	 */
	public static String doPostOrGet(String url, Map<String, Object> paramsMap, String method) throws Exception {
		String params = paramsConvertUrl(paramsMap);
		...
		if ("POST".equals(method)) {
			...
			throw new Exception("发送Http请求方法异常！");
		}
	}

	// Map转化成url拼接请求参数
	public static String paramsConvertUrl(Map<String, Object> paramsMap) {
